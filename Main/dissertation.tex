...
\usepackage{bookmark}
\usepackage{enumitem}
\setenumerate[1]{itemsep=2pt,partopsep=-15pt,parsep=0pt,topsep=-5pt}
\setitemize[1]{itemsep=2pt,partopsep=-15pt,parsep=0pt,topsep=-5pt}
\setdescription{itemsep=2pt,partopsep=-15pt,parsep=0pt,topsep=-5pt}
...
\setmycommitteec{Lawrence Holder}
%\setmycommitteed{Fourth Committee Member}
%\setmycommitteee{Fifth Committee Member}

\setmytitle{\textbf{SEEKER: Knowledge-based Q \& A System for Wiki Farms}} %Title
